...
Mobile-first personal fitness, mobility, running, nutrition, and progress tracker built around a structured six-month training plan.
...
- **Hosting:** Vercel
- **Persistence:** server-backed Postgres APIs; no longer dependent on browser localStorage
...
That document is intentionally a living spec. It includes:
...
4. Let the LLM use live training, pain, mobility, nutrition, and adherence data to adjust future programming.
