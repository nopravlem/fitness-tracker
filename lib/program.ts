...
{name:'Push-up Progression',target:'3 × 6–10',note:'Incline or wall. Lower the incline only after clean reps.',sets:3,defaultWeight:'bodyweight'},
...
{name:'Dead Bug',target:'3 × 8 / side',sets:3,defaultWeight:'bodyweight'}
];
...
{name:'Push-up Progression',target:'3 × 6–10',sets:3,defaultWeight:'bodyweight'},
...
{name:"Captain's Chair Knee Raise",target:'3 × 8–12',sets:3,defaultWeight:'bodyweight'},
...
{name:'Plank / Side Plank',target:'2–3 sets',sets:3,defaultWeight:'bodyweight'}
];
...
3:{key:'solidcore-default',label:'Solidcore',kind:'solidcore',duration:'Signature50',description:'Default weekly Solidcore day. Actual booked classes override this template; off-Wednesday bookings swap with the session they displace.',mobility:['Optional short mobility only if it feels good']},
...
'2026-09-02':{key:'B-swap-0902',label:'Strength B',kind:'strength',duration:'55–70 min',description:'Moved from Thursday because Solidcore is booked on Sep 3. This is a swap, not extra training.',exercises:strengthB,mobility:['Hip control','Ankle/calf','Neck + thoracic']},
'2026-09-03':{key:'solidcore-0903',label:'Solidcore',kind:'solidcore',duration:'11:05 am · Signature50',description:'Upper East Side · Center Glutes & Back. Swapped with this week’s Strength B session.',mobility:['Optional short mobility only if it feels good']},
'2026-09-08':{key:'solidcore-0908',label:'Solidcore',kind:'solidcore',duration:'9:05 am · Signature50',description:'Upper East Side · Center Glutes & Chest. Swapped with this week’s easy cardio session.',mobility:['Optional short mobility only if it feels good']},
'2026-09-09':{key:'cardio-swap-0909',label:'Easy cardio + mobility',kind:'cardio',duration:'30–45 min',description:'Moved from Tuesday because Solidcore is booked on Sep 8. This is a swap, not extra training.',cardio:'30–40 min bike, elliptical, or incline walk',mobility:['90/90','Hip flexor','Adductor rock-backs','Ankle/calf','Neck + thoracic']},
'2026-09-16':{key:'solidcore-0916',label:'Solidcore',kind:'solidcore',duration:'2:05 pm · Signature50',description:'Upper East Side · Center Glutes & Shoulders. This lands on the default Wednesday Solidcore day.',mobility:['Optional short mobility only if it feels good']},
'2026-09-23':{key:'C-swap-0923',label:'Strength C + run',kind:'strength',duration:'60–80 min',description:'Moved from Saturday because Solidcore is booked on Sep 26. This is a swap, not extra training.',exercises:strengthC,cardio:'Run/walk progression below symptom threshold',mobility:['Split practice','Hip flexor','Hamstring','Adductors']},
'2026-09-26':{key:'solidcore-0926',label:'Solidcore',kind:'solidcore',duration:'2:00 pm · Signature50',description:'Upper East Side · Hamstrings & Arm Wrap. Swapped with this week’s Strength C + run session.',mobility:['Optional short mobility only if it feels good']}
};
