...
export default function ProgressPage(){
  ...
  function startAdd(){setEditingId(0);setForm(emptyForm())}
  function startEdit(row:ProgressRow){setEditingId(row.id);setForm(rowToForm(row))}
